...
$l['setting_ougc_feedback_latest_profile_feedback'] = 'Show Latest Feedback in Profiles';
$l['setting_ougc_feedback_latest_profile_feedback_desc'] = 'If set, show a set amount of feedback in user profiles.';

...
//$l['setting_ougc_feedback_allow_email_pm'] = 'Allow PM Notification';
//$l['setting_ougc_feedback_allow_email_pm_desc'] = 'Allow users to be notified via PM.';
//$l['setting_ougc_feedback_allow_email_alert'] = 'Allow Alert Notification';
//$l['setting_ougc_feedback_allow_email_alert_desc'] = 'Allow users to be notified via a plugin alert.';
